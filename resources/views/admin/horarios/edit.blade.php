...
<body>
    <div class="container-fluid">
        <form action="{{url('/admin/horarios/'.$horario->id)}}" method="POST" class="mx auto">
            @csrf
            @method('PUT')
            <h4 class=text-center>Modificar un horario</h4>
            <br>
            <div class="mb-3">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <select name="consultorio_id" id="consultorio_select" class="form-control">
                            <option value="{{$horario->consultorio->id}}">{{$horario->consultorio->nombre}} - {{$horario->consultorio->ubicacion}}</option>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <select name="doctor_id" id="" class="form-control">
                        //<option value="{{$horario->doctor->id}}">{{$horario->doctor->nombre}} {{$horario->doctor->apellidos}} - {{$horario->doctor->especialidad}}</option>
